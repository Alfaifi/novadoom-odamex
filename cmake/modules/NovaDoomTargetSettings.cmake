...
function(novadoom_target_settings _TARGET)
  set(NOVADOOM_DLLS "")
  ...
  if(MSVC)
    ...
    target_compile_definitions("${_TARGET}" PRIVATE
      $<$<CONFIG:Debug>:NOVADOOM_DEBUG> _CRT_SECURE_NO_WARNINGS)
    target_compile_options("${_TARGET}" PRIVATE /MP)
  else()
    target_compile_definitions("${_TARGET}" PRIVATE
      $<$<CONFIG:Debug>:NOVADOOM_DEBUG>)
  ...
  foreach(NOVADOOM_DLL ${NOVADOOM_DLLS})
    add_custom_command(TARGET "${_TARGET}" POST_BUILD
      ...
      "${NOVADOOM_DLL}" $<TARGET_FILE_DIR:${_TARGET}> VERBATIM)
  endforeach()
endfunction()
